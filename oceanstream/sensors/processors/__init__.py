...
SensorProcessorFunc = Callable[[Path, FileInfo, SensorInfo, str], SensorDescriptor]
RawProcessorFunc = Callable[[Path, FileInfo, SensorInfo, SensorDescriptor], Path]
...
from . import eco_flntu  # noqa: F401, E402
from . import minisvs  # noqa: F401, E402
from . import sbe911  # noqa: F401, E402
from . import lci90i  # noqa: F401, E402
