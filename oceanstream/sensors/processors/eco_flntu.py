"""WETLabs ECO-FLNTU fluorometer sensor processors.

This module provides both a SensorDescriptor builder and a raw-data
processor for WETLabs ECO-FLNTU fluorometer instruments.
"""
...
def fluorometer_descriptor_processor(
    ...
    """Build a SensorDescriptor for a WETLabs ECO-FLNTU fluorometer.
...
def fluorometer_raw_processor(
    ...
    """Process ECO-FLNTU fluorometer raw data into a simple CSV file.

    Fluorometer ``*.Raw`` files appear to contain lines of the form::
