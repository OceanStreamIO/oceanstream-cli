"""Valeport miniSVS surface sound velocity sensor processors.

Like :mod:`eco_flntu`, this module defines both a SensorDescriptor
builder and a raw-data processor for SSV instruments.
"""
...
def ssv_descriptor_processor(
    ...
    """Build a SensorDescriptor for a Valeport miniSVS instrument."""
...
def ssv_raw_processor(
    ...
    """Process Valeport miniSVS raw data into a simple CSV file.

    SSV ``*.Raw`` files contain lines of the form::
